...
Usage:
    from screener.evaluators import get_evaluator, EVALUATOR_MAP
    from screener.evaluators.ma import eval_ma_touch
    from screener.evaluators.rsi import eval_rsi_oversold
"""
