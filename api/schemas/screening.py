...
# --- Saved screening results schemas ---


class SaveScreeningResultRequest(BaseModel):
    """Request payload for saving a screening result."""
...
class SavedScreeningResultSummary(BaseModel):
    """Lightweight summary of a saved screening result (excludes results data)."""
...
class SavedScreeningResultResponse(SavedScreeningResultSummary):
    """Full saved screening result including results data."""

    results: List[ScreeningResultItem]


class SavedScreeningResultListResponse(BaseModel):
    """Paginated list of saved screening result summaries."""

    results: List[SavedScreeningResultSummary]
    total_count: int
