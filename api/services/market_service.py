    ...
    def get_technical_indicators(
        ...
        try:
            ...
            return {
                ...
                "macd_prev_histogram": self._round_value(indicators.get("macd_prev_histogram")),
                ...
                "stochastic_k": self._round_value(indicators.get("stochastic_k")),
                "stochastic_d": self._round_value(indicators.get("stochastic_d")),
                "obv": self._round_value(indicators.get("obv"), decimals=0),
